...
const BooksPage = () => {
  ...
  // Hay más resultados si lo cargado es menor al total (limitamos a 200 porque Google Books
  // a veces reporta totales de millones que no son reales)
  ...
  return (
    <div className="page-container" style={{ padding: '2rem' }}>
      ...
      <header style={{
        ...
        <form onSubmit={handleSearchSubmit} style={{ display: 'flex', gap: '10px', maxWidth: '500px' }}>
          ...
          <button type="submit" style={{
            background: TYPE_COLOR, border: 'none', borderRadius: '8px',
            padding: '0 20px', cursor: 'pointer', color: 'white', fontWeight: 'bold'
          }}>
            <Search size={20} />
          </button>
        </form>
      ...
      {/* ESTADO INICIAL — no ha buscado nada todavía */}
                ...
                <div key={book.id} className="anime-card">
                  <div className="card-image-wrapper" style={{ position: 'relative', height: '280px', overflow: 'hidden', background: '#2a2a2a' }}>
                    ...
                    {info.averageRating && (
                      <div style={{
                        ...
                        background: TYPE_COLOR, color: 'white', padding: '2px 6px',
                  ...
                  <div className="card-info" style={{ padding: '1rem' }}>
                    <h3 className="card-title" style={{
                      ...
                      textOverflow: 'ellipsis', color: 'white', marginBottom: '0.5rem'
                    }}>
                      {info.title}
                    </h3>
